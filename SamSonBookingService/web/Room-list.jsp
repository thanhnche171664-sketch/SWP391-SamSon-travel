...
function proceedToBooking() {
    ...
    // Store cart data for next page
    sessionStorage.setItem('selectedRooms', JSON.stringify(roomCart));
    sessionStorage.setItem('totalAmount', cartTotal.toString());
    
    alert('Đã lưu ' + roomCart.length + ' loại phòng vào giỏ. Tiếp tục nhập thông tin khách hàng...');
    // TODO: Redirect to customer info page
    // window.location.href = 'customer-info.jsp';
}
