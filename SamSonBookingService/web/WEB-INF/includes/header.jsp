        ...
        <div class="header-container">
            ...
            <nav class="nav" id="nav" role="navigation" aria-label="Main navigation">
                <ul class="nav-list" id="navigation">
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/home#home" class="nav-link">Trang chủ</a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/home#tours" class="nav-link">Tours</a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/home#hotels" class="nav-link">Khách sạn</a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/home#destinations" class="nav-link">Điểm đến</a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/home#about" class="nav-link">Về chúng tôi</a>
                    </li>
                    <li class="nav-item">
