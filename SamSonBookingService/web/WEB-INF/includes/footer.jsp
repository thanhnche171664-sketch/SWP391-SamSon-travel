            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        <li><a href="${pageContext.request.contextPath}/home#tours">Tours du lịch</a></li>
                        <li><a href="${pageContext.request.contextPath}/home#hotels">Khách sạn</a></li>
                        <li><a href="${pageContext.request.contextPath}/home#destinations">Điểm đến</a></li>
