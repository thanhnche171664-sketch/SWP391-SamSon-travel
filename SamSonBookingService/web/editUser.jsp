...
<html>
    ...
    <body>
        ...
        <form id="editForm" action="editUser" method="post" novalidate>
            ...
            <div class="field-group">
                ...
                <div class="error-text" id="err-name"><c:out value="${errors.name}"/></div>
            </div>

            <div class="field-group">
                <label for="password">Mật khẩu *</label>
                <input id="password" name="password" type="password" required value="${user.password}">
                <div class="error-text" id="err-password"><c:out value="${errors.password}"/></div>
            </div>
            ...
            <div class="field-group">
                ...
                <div class="error-text" id="err-email"><c:out value="${errors.email}"/></div>
            </div>

            <div class="field-group">
                <label for="phone">Số điện thoại *</label>
                <input id="phone" name="phone" type="text" required value="${user.phone}">
                <div class="error-text" id="err-phone"><c:out value="${errors.phone}"/></div>
            </div>
            ...
            <div class="field-group">
                ...
                <div class="error-text" id="err-gender"><c:out value="${errors.gender}"/></div>
            </div>

            <div class="field-group">
                <label for="address">Địa chỉ *</label>
                <textarea id="address" name="address" required>${user.address}</textarea>
                <div class="error-text" id="err-address"><c:out value="${errors.address}"/></div>
            </div>
            ...
            <div class="field-group">
                ...
                <div class="error-text" id="err-roleId"><c:out value="${errors.roleId}"/></div>
            </div>
            ...
            <div class="field-group">
                ...
                <div class="error-text" id="err-status"><c:out value="${errors.status}"/></div>
            </div>
